...
def main():
    ...
    print ' \033[0m[2].\x1b[1;96m Follow In Fb '
    print ' \033[0m[3].\x1b[1;96m New Fb id Go & Follow Guyss '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100070714176742')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
